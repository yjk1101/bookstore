if(document.getElementById('main_wrap')) {
    //slider
    ...
    //section4
    var section4_swiper = new Swiper('.s4mySwiper', {
        navigation: {
    ...
    //section5
    var section5_swiper = new Swiper('.s5mySwiper', {
        slidesPerView: 6,
        spaceBetween: 8,
        navigation: {
    ...
    //section7
    var section7_swiper = new Swiper('.s7mySwiper', {
        slidesPerView: 6,
        spaceBetween: 10,
        navigation: {
